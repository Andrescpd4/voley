...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-09-2026 a las 22:36:16
...
(29, 'diseno', 'administracion', 'Diseño', 'modulos/diseno', 'ver', 150, 'S', '7', 'ri-paint-brush-line', NULL, '_self'),
(30, 'sesion', NULL, 'Sesion', 'modulos/sesion', 'ver', 98, 'S', '7', 'ri-lock-line', NULL, '_self');
...
(28, 3, 'comunicados'),
(26, 3, 'escuela'),
(140, 4, 'administracion'),
(148, 4, 'afiliacion'),
(150, 4, 'asistencia'),
(143, 4, 'clave_usuarios'),
(152, 4, 'comunicados'),
(149, 4, 'deportistas'),
(146, 4, 'diseno'),
(147, 4, 'escuela'),
(151, 4, 'eventos'),
(144, 4, 'permisos-por-rol'),
(145, 4, 'restaurar_clave'),
(142, 4, 'roles'),
(141, 4, 'usuarios');
...
(149, 'dohHrvq1GrOfI9ixtQb3qW2vHceJsZYTYjjBBmBJnkbuglZAsDCT+Ro4w/hc7BCH1UdgBeHd7bD6z6+HKJTp5Ir8kyJ8exRm0G4f8Rwm/JR2jrW0+OWSRpODrIvMnfuM', '2026-09-22', 1, 1, '2026-09-22 20:30:41');
...
--
-- Estructura de tabla para la tabla `diseno_tema`
--

CREATE TABLE `diseno_tema` (
  `id` int(11) NOT NULL,
  `nombre` varchar(100) NOT NULL,
  `activo` tinyint(1) NOT NULL DEFAULT 0,
  `primaria` varchar(7) NOT NULL DEFAULT '#405189',
  `secundaria` varchar(7) NOT NULL DEFAULT '#6c757d',
  `exito` varchar(7) NOT NULL DEFAULT '#198754',
  `info` varchar(7) NOT NULL DEFAULT '#0dcaf0',
  `advertencia` varchar(7) NOT NULL DEFAULT '#ffc107',
  `peligro` varchar(7) NOT NULL DEFAULT '#dc3545',
  `claro` varchar(7) NOT NULL DEFAULT '#f8f9fa',
  `oscuro` varchar(7) NOT NULL DEFAULT '#212529',
  `gris100` varchar(7) DEFAULT NULL,
  `gris200` varchar(7) DEFAULT NULL,
  `gris300` varchar(7) DEFAULT NULL,
  `gris400` varchar(7) DEFAULT NULL,
  `gris500` varchar(7) DEFAULT NULL,
  `gris600` varchar(7) DEFAULT NULL,
  `gris700` varchar(7) DEFAULT NULL,
  `gris800` varchar(7) DEFAULT NULL,
  `gris900` varchar(7) DEFAULT NULL,
  `fuente_base` varchar(100) DEFAULT NULL,
  `fuente_titulo` varchar(100) DEFAULT NULL,
  `tamano_base` decimal(4,2) NOT NULL DEFAULT 1.00,
  `escala_espaciado` decimal(4,2) NOT NULL DEFAULT 1.00,
  `dark_mode` tinyint(1) NOT NULL DEFAULT 0,
  `fecha_actualiz` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `diseno_tema`
--

INSERT INTO `diseno_tema` (`id`, `nombre`, `activo`, `primaria`, `secundaria`, `exito`, `info`, `advertencia`, `peligro`, `claro`, `oscuro`, `gris100`, `gris200`, `gris300`, `gris400`, `gris500`, `gris600`, `gris700`, `gris800`, `gris900`, `fuente_base`, `fuente_titulo`, `tamano_base`, `escala_espaciado`, `dark_mode`, `fecha_actualiz`) VALUES
(1, 'Tema por Defecto', 1, '#405189', '#6c757d', '#198754', '#0dcaf0', '#ffc107', '#dc3545', '#f8f9fa', '#212529', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1.00, 1.00, 0, '2026-09-22 08:04:11');
...
(1, 1, 4, 'ADMIN', '$2y$10$EaspXXDFKIuN3Noj6N.fKOd5WaAxkY5pTNHp1N/siGSMortH1MYky', 1, '2026-09-22 19:04:09', '2026-09-16 15:14:39', '2026-09-22 19:04:09'),
...
--
-- Indices de la tabla `diseno_tema`
--
ALTER TABLE `diseno_tema`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `diseno_tema`
--
ALTER TABLE `diseno_tema`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
