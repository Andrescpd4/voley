                                            ...
                                            <div style="width:100%; margin:auto;height: 100%">
                                                <table style="width:100%">
                                                 <div class="form-group row">
                                                     ...
                                                     <div class="col-sm-10">
                                                        <input type="text" id="bnombre" name="nombre" title="Nombre" placeholder="Nombre" maxlength="60" value="" />
                                                     </div>
                                                 </div>
                                                </table>
                            ...
                            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                              ...
                              <form id="formulario">
                                   ...
                                   <div class="form-group row" style="display:none">
                                                     ...
                                                     <label for="accion" class="col-sm-2 col-form-label">Nombre</label>
                                                     <div class="col-sm-10">
                                                        <input type="text" id="nombre" name="nombre" title="Nombre" placeholder="Nombre" maxlength="60" value="" />
                                                     </div>
                                                 </div>
