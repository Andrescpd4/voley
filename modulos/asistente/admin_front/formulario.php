                                            ...
                                            <div style="width:100%; margin:auto;height: 100%">
                                                <table style="width:100%">
                                                 <div class="form-group row">
                                                     ...
                                                     <div class="col-sm-10">
                                                        <input type="text" id="bnombre" name="nombre" title="Nombre" placeholder="Nombre" maxlength="250" value="" />
                                                     </div>
                                                 </div>
                                                </table>
                            ...
                            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                              ...
                              <form id="formulario">
                                   ...
                                   <div class="form-group row" style="display:none">
                                                     ...
                                                     <label for="accion" class="col-sm-2 col-form-label">Nombre</label>
                                                     <div class="col-sm-10">
                                                        <input type="text" id="nombre" name="nombre" title="Nombre" placeholder="Nombre" maxlength="250" value="" />
                                                     </div>
                                                 </div><div class="form-group row">
                                                     <label for="accion" class="col-sm-2 col-form-label">Class</label>
                                                     <div class="col-sm-10">
                                                        <input type="text" id="class" name="class" title="Class" placeholder="Class" maxlength="250" value="" />
                                                     </div>
                                                 </div><div class="form-group row">
                                                     <label for="accion" class="col-sm-2 col-form-label">¿Activo?</label>
                                                     <div class="col-sm-10">
                                                        <select id="active" name="active" title="Active">
                                                        <?php echo get_si_no(true,true); ?>
                                                      </select>
                                                     </div>
                                                 </div>

                                                 <div class="form-group row">
                                                     <label for="accion" class="col-sm-3 col-form-label">Color primario</label>
                                                     <div class="col-sm-3">
                                                        <input type="color" id="color_primario" name="color_primario" title="Color primario" placeholder="Color primario" maxlength="50" value="" />
                                                     </div>
                                                 
                                                     <label for="accion" class="col-sm-3 col-form-label">Color secundario</label>
                                                     <div class="col-sm-3">
                                                        <input type="color" id="color_secundario" name="color_secundario" title="Color secundario" placeholder="Color secundario" maxlength="50" value="" />
                                                     </div>
                                                 </div>


                                                 <div class="form-group row">
                                                     <label for="accion" class="col-sm-2 col-form-label">¿Visible?</label>
                                                     <div class="col-sm-10">
                                                     ...
                                                     <label for="accion" class="col-sm-2 col-form-label">Img</label>
                                                     <div class="col-sm-10">
                                                        <input type="text" id="img" name="img" title="Img" placeholder="Img" maxlength="150" value="" />
                                                     </div>
                                                 </div>
