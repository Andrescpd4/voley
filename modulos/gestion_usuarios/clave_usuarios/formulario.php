...
$(function(){
      ...
      $("#formulario").submit(function(){
            ...
            if (r.error == true)
            {
                ...
                msg($(".respuesta"),r.msg,"danger");
                ver();
            } else
            {
                msg($(".respuesta"),r.msg,"success");
                ver();
...
<!-- FORMULARIO -->
 <div class="card">
            ...
            <label for="accion" class="col-sm-2 col-form-label">Usuario</label>
             <div class="col-sm-10">
                <input type="hidden" name="persona_id" id="persona_id" 
                           class="no-modificable" title="Persona" required>
    ...
    <div class="box-footer"><br>
        <button class="btn btn-square btn-outline-info tooltip_btn" style="float: right;" 
           id="btn_aceptar"
           type="submit" 
